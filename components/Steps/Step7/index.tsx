            ...
            <Grid display="flex" flexDirection="column" gap={2}>
                <Grid size={12}>
                    <Grid display="flex" gap={2} alignItems="center">
                        ...
                        />
                        <FormControl className="portfolioLabel" sx={{ width: "100% !important" }}>Gizlilik Politikası<span className="labelRequired" style={{ marginLeft: 4 }}>*</span></FormControl>
                    </Grid>
                </Grid>
                <Grid size={12}>
                    <Grid display="flex" gap={2} alignItems="center">
                        ...
                        />
                        <FormControl className="portfolioLabel" sx={{ width: "100% !important" }}>Kullanım Koşulları<span className="labelRequired" style={{ marginLeft: 4 }}>*</span></FormControl>
                    </Grid>
                </Grid>
                <Grid size={12}>
                    <Grid display="flex" gap={2} alignItems="center">
                        ...
                        />
                        <FormControl className="portfolioLabel" sx={{ width: "100% !important" }}>Keşfette Görünürlük Onayı</FormControl>
                    </Grid>
                </Grid>
            </Grid>
            <Modal
            ...
            >
                <Box sx={style}>
                    ...
                    <Typography sx={{ mt: 2,whiteSpace:"pre-line" }}>
                        {ModalContents[modal.type]?.content}
                    </Typography>
                    <Grid size={12} display="flex" gap={4} justifyContent="space-around" marginTop={3}>
                        <Button variant='contained' color='success' type='button' onClick={() => {
                            formik.setFieldValue(modal.type, true);
                            setModal((prev) => ({ ...prev, isOpen: false }))
                        }}>{ModalContents[modal.type]?.complatedButtonText}</Button>
                        <Button variant='contained' color='error' type='button' onClick={() => {
                            setModal((prev) => ({ ...prev, isOpen: false }))
                        }}>{ModalContents[modal.type]?.cancelButtonText}</Button>
                    </Grid>
                </Box>
            </Modal>
        </>
