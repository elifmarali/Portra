...
export async function GET(req: Request) {
  ...
  try {
    ...
    console.error("ERR [PortfolioList/GET] : ", err instanceof Error ? err.message : err);
    return new Response(JSON.stringify({ succcess: false, message: "ERR [PortfolioList/GET]" }), {
      status: 500,
    });
  }
}
